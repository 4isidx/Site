  ...
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          >
            ...
            >
              ...
              <span className="text-primary block">Иван Разработчиков</span>
            </motion.h1>
            <motion.p 
            ...
            >
              Full-Stack разработчик, специализирующийся на создании современных веб-приложений с отзывчивым интерфейсом и высокой производительностью.
            </motion.p>
            <motion.div 
            ...
            >
              ...
              <Link 
                href="/contact" 
                className="px-6 py-3 bg-white dark:bg-gray-700 text-gray-900 dark:text-white font-medium rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
              >
                Связаться со мной
              </Link>
            </motion.div>
        ...
        <motion.div 
          className="flex justify-center lg:justify-start mt-12 space-x-6"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.8, duration: 0.5 }}
        >
          <a href="https://github.com/username" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            <svg className="h-6 w-6 text-gray-700 dark:text-gray-300 hover:text-primary dark:hover:text-primary-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
